var ropeDemo = {
    ...
    Step: function () {
        ...
        if (
            Math.abs(ropeDemo.rope.coeff) > 0.00001 || 
            isNaN(ropeDemo.rope.coeff)
        ){
    ...
    Initialize: function () {
        ...
        ropeDemo.context.img0.src = 'bulb-off.png';
        ropeDemo.context.img1.src = 'bulb-on.png';
